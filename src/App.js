    ...
    <div className="admin-panel">
      <div className={"container_flex_col admin-left-side"}>
        ...
        <div className={"container_flex_col admin_button_section"}>
          <button
            className={currentPage === "Page1" ? "selected btn" : ""}
            onClick={() => handleButtonClick("Page1")}
          >
            Dashboard
          </button>
          <button
            className={currentPage === "Page2" ? "selected btn" : ""}
            onClick={() => handleButtonClick("Page2")}
          >
            Books
          </button>
          <button
            className={currentPage === "Page3" ? "selected btn" : ""}
            onClick={() => handleButtonClick("Page3")}
          >
            Issued Books
          </button>
          <button
            className={currentPage === "Page4" ? "selected btn" : ""}
            onClick={() => handleButtonClick("Page4")}
          >
            Returned Books
          </button>
          <button
            className={currentPage === "Page5" ? "selected btn" : ""}
            onClick={() => handleButtonClick("Page5")}
          >
            Students
          </button>
        </div>
